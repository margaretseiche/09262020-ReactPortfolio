                ...
                <div className="row">
                  ...
                  <div className="col-sm">
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/TravelPlanner.JPG" class="card-img-top" id="card-image"
                      ...
                      <div className="card-body">
                        ...
                        <a href="https://margaretseiche.github.io/Project-1-Playground/" class="btn btn-primary"
                          id="button" style={style.image} target="_blank" rel="noopener noreferrer">Plan a Trip</a>
                        <a href="https://github.com/margaretseiche/Project-1-Playground" class="btn btn-primary"
                  ...
                  <div className="col-sm">
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/PasswordGenerator.JPG" class="card-img-top" id="card-image"
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text">Created a means for users to generate random passwords with specified
                          criteria</p>
                        <a href="https://margaretseiche.github.io/05212020-Password-Generator/" class="btn btn-primary"
                          id="button" style={style.image} target="_blank" rel="noopener noreferrer">Try it Out</a>
                        <a href="https://github.com/margaretseiche/05212020-Password-Generator" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">See the Code</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-sm">
                    ...
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/DayPlanner.JPG" class="d-block w-100" alt=""/>
                      <div className="card-body">
                        ...
                        <a href="https://margaretseiche.github.io/07072020-DayPlannerAndWeather/" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">Plan Your Day</a>
                        <a href="https://github.com/margaretseiche/07072020-DayPlannerAndWeather" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">See the Code</a>
            ...
            <div className="col-md-4" id="back">
              ...
              <div className="row" id="featurePortfolioHeading">Back-End
                <div className="row">
                  ...
                  <div className="col-sm">
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/local4.JPG" class="card-img-top" id="card-image" alt=""/>
                      <div className="card-body">
                        ...
                        <a href="https://mburgerapp.herokuapp.com" class="btn btn-primary" id="button"
                          target="_blank" rel="noopener noreferrer">Order a Burger</a><br/>
                        <a href="https://github.com/margaretseiche/08082020-Handlebars-Burgers" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">See the Code</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm">
                    ...
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/EmployeeDirectory.JPG" class="d-block w-100" alt=""/>
                      <div className="card-body">
                        ...
                        <p className="card-text">Developed a Command Line Interface for creating a team profile webpage with
                          Handlebars</p>
                        <a href="https://youtu.be/yS8ZmDgy3n8" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">Watch the demo</a> 
                        <a href="https://github.com/margaretseiche/07162020-EmployeeDirectory" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">See the Code</a>
                  ...
                  <div className="col-sm">
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/ReadMeDemo.JPG" class="card-img-top" id="card-image"
                        alt="snapshot of password generator"/>
                      <div className="card-body">
                        <h5 className="card-title">ReadMe Generator</h5>
                        <p className="card-text">Created a command line interface for developers to make formatted ReadMe files</p>
                        <a href="https://youtu.be/C4KLrUpt-M8" class="btn btn-primary"
                          id="button" style={style.image} target="_blank" rel="noopener noreferrer">Watch the demo</a>
                        <a href="https://github.com/margaretseiche/07112020-ReadmeGenerator" class="btn btn-primary"
                          id="button" target="_blank" rel="noopener noreferrer">See the Code</a>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-md-4" id="other">
              <div className="row" id="featurePortfolioHeading">Other Experience
                <div className="row">
                  ...
                  <div className="col-sm">
                    <div className="card" id="portfolio-card">
                      <img src="./assets/images/FBCwebsite.JPG" class="card-img-top" id="card-image"
                      ...
                      <div className="card-body">
                        ...
                        <a href="./assets/Churchwebsite_originalversion.pdf" class="btn btn-primary" id="button"
                          style={style.image} target="_blank" rel="noopener noreferrer">Before</a>
                        <a href="https://www.fbcflushing.org/" class="btn btn-primary" id="button"
                  ...
                  <div className="col-sm">
                    <div className="card" id="portfolio-card">
                      <video src="./assets/acamis.mp4" class="card-img-top" controls muted >Video of a
                        conference</video>
                      <div className="card-body">
                  ...
                  <div className="col-sm">
                    ...
                    <div className="card" id="portfolio-card">
                      <div id="carouselExampleIndicators" class="carousel slide">
                        ...
                        <div className="carousel-inner">
                          <div className="carousel-item active">
                            <img src="./assets/images/FriendsPage1.JPG" class="d-block w-100"
                              alt="Friends of Dulwich Beijing"/>
                          </div>
                          <div className="carousel-item">
                            <img src="./assets/images/FriendsPage2.JPG" class="d-block w-100"
                              alt="Friends means friendship."/>
                          </div>
                          <div className="carousel-item">
                            <img src="./assets/images/FriendsPage3.JPG" class="d-block w-100" alt="Fun while fundraising"/>
                          </div>
                          <div className="carousel-item">
                            <img src="./assets/images/FriendsPage4.JPG" class="d-block w-100"
                              alt="Partnership with the school."/>
                          </div>
                          <div className="carousel-item">
                            <img src="./assets/images/FriendsPage5.JPG" class="d-block w-100"
                              alt="Fundraising is part of Friends."/>
                          </div>
                          <div class="carousel-item">
                            <img src="./assets/images/FriendsPage6.JPG" class="d-block w-100"
                              alt="Friends is about friendship too."/>
                          </div>
                          <div class="carousel-item">
                            <img src="./assets/images/FriendsPage7.JPG" class="d-block w-100"
                      ...
                      <div className="card-body">
                        ...
                        <a href="./assets/Friends2006to2016.pdf" class="btn btn-primary" id="button"
